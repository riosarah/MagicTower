//@CodeCopy
#if ACCOUNT_ON
using MagicTower.Logic.Entities.Account;
using MagicTower.Logic.Modules.Exceptions;
using MagicTower.Logic.Modules.Security;
using System.Text;

namespace MagicTower.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using MagicTower.Common.Modules.ThreadSafe;
